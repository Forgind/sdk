    ...
    public partial class SdkDirectoryWorkloadManifestProvider : IWorkloadManifestProvider
    {
        ...
        public WorkloadVersionInfo GetWorkloadVersion()
        {
            if (_globalJsonWorkloadSetVersion != null)
            {
                ...
                return new WorkloadVersionInfo(_globalJsonWorkloadSetVersion, IsInstalled: _exceptionToThrow == null, WorkloadSetsEnabledWithoutWorkloadSet: false, _globalJsonPathFromConstructor, GlobalJsonSpecifiesWorkloadSets: _globalJsonSpecifiedWorkloadSets);
            }
